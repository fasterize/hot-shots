...
function applyStatsFns(Client) {
  /**
   * Extra tools
   * Compute the duration of the execution of a task provided as an argument.
   * @param fn {Function(done)} The task, it needs to call `done` after finishing the task.
   ...
   */
  Client.prototype.duration = function (fn, stat, sampleRate, tags, callback) {
    ...
    const whenFinished = () => {
      ...
      this.timing(stat, duration, sampleRate, tags, callback);
      return duration;
    };
   ...
   * @param callback {Function=} Callback when message is done being delivered. Optional.
   */
  Client.prototype.asyncTimer = function (
    func,
    stat,
    sampleRate,
    tags,
   ...
   * @param callback {Function=} Callback when message is done being delivered. Optional.
   */
  Client.prototype.asyncDistTimer = function (
    func,
    stat,
    sampleRate,
    tags,
    ...
    return (...args) => {
      ...
      const p = func(...args);
      const recordStat = () =>
        self.distribution(stat, end(), sampleRate, tags, callback);
      p.then(recordStat, recordStat);
      return p;
    };
  };
   ...
   * @param callback {Function=} Callback when message is done being delivered. Optional.
   */
  Client.prototype.increment = function (
    stat,
    value,
    sampleRate,
    tags,
   ...
   * @param callback {Function=} Callback when message is done being delivered. Optional.
   */
  Client.prototype.decrement = function (
    stat,
    value,
    sampleRate,
    tags,
   ...
   * @param callback {Function=} Callback when message is done being delivered. Optional.
   */
  Client.prototype.histogram = function (
    stat,
    value,
    sampleRate,
    tags,
   ...
   * @param callback {Function=} Callback when message is done being delivered. Optional.
   */
  Client.prototype.unique = Client.prototype.set = function (
    stat,
    value,
    sampleRate,
    tags,
